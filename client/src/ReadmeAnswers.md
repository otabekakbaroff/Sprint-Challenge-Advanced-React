...
Because of State and Lifecycle which hooks replaced in functional components.

- [ ] Name three lifecycle methods and their purposes.
  ComponentDidMount(), ComponentDidUpdate(), ComponentDidUnmount()
- [ ] What is the purpose of a custom hook?
    The purpose of custom hooks is to make our code reusable and dry.
- [ ] Why is it important to test our apps?
Testing makes our codebase more reliable and will prevent buggs when codebase gets bigger 
